 ...
 * @author dodge1
 */
public class Plot1Frame extends PersistentPositionContainer{

    private final PlotPanelTab plotPanelTab;
     private Plot1Frame( String preferencePath, String title, int width, int height )
    {
        super(preferencePath, title, width,height );

        plotPanelTab = new PlotPanelTab(this,Plot1Panel.getInstance());
    ...
    public static Plot1Frame getInstance() {
        return PlotFrameHolder.INSTANCE;
    }

    private static class PlotFrameHolder {

        private static final Plot1Frame INSTANCE = new Plot1Frame( "gov/llnl/gnem/jsac/plot1", "plot1", 600, 600);
    }
}
