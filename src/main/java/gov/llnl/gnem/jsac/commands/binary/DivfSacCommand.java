 ...
 * @author dodge1
 */
public class DivfSacCommand implements SacCommand {
    ...
    public void execute() {
        ...
        Misc.buildAndProcessList(filenames, BinOpType.DIV,replaceHeaders);
    }
    ...
    public String getHelpString() {
        return "SUMMARY\n"
                ...
                + "DESCRIPTION\n"
                + "	This command can be used to divide a set of files by a single file or by another set of files. \n"
