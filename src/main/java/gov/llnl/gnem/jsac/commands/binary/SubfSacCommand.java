 ...
 * @author dodge1
 */
public class SubfSacCommand implements SacCommand {
    ...
    public void execute() {
        ...
        Misc.buildAndProcessList(filenames, BinOpType.SUB,replaceHeaders);
    }
    ...
    public String getHelpString() {
        return "SUMMARY\n"
                + "	Subtracts a set of data files to data in memory.\n"
                + "\n"
                + "SYNTAX\n"
                ...
                + "DESCRIPTION\n"
                + "	This command can be used to subtract a single file from a set of files or to subtract one set of files from another set. \n"
