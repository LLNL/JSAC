 ...
 * @author dodge1
 */
public class AddfSacCommand implements SacCommand {
    ...
    public void execute() {
        ...
        Misc.buildAndProcessList(filenames, BinOpType.ADD,replaceHeaders);
    }
    ...
    public String getHelpString() {
        return "SUMMARY\n"
                ...
                + "DESCRIPTION\n"
                + "	This command can be used to add a single file to a set of files or to add one set of files to another set. \n"
