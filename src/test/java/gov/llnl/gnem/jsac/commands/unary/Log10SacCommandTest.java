...
public class Log10SacCommandTest {
    ...
    @Test
    public void testLog10AllPositive() {
        ...
        TestUtil.runCommand("add 1", new AddSacCommand());
        TestUtil.runCommand("log10", new Log10SacCommand());

        SacTraceData truth = TestUtil.getTruth("log10Add1Truth.sac", TEST_FILE_DIRECTORY);
        TestUtil.compareTwoSacfileArraysExact(result1, truth, "testLog10AllPositive", tolerance);
    }
}
