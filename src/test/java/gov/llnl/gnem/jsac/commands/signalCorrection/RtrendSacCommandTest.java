...
public class RtrendSacCommandTest {
    ...
    public void defaultRtrend() {
        ...
        TestUtil.runCommand("rtrend", new RtrendSacCommand());

        SacTraceData truth = TestUtil.getTruth("rtrendTruth.sac", TEST_FILE_DIRECTORY);
        TestUtil.compareTwoSacfileArraysExact(truth, test, "defaultRtrend", tolerance);
    }
