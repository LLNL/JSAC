...
public class LogSacCommandTest {
    ...
    @Test
    public void testLogAllPositive() {
        ...
        TestUtil.runCommand("log", new LogSacCommand());

        SacTraceData truth = TestUtil.getTruth("logAdd1Truth.sac", TEST_FILE_DIRECTORY);
        TestUtil.compareTwoSacfileArraysExact(result1, truth, "testLogAllPositive", tolerance);
    }
}
