...
public class SubSacCommandTest {
    ...
    /**
     * Test reading in multiple files and subtracting different scalars from
     * each
     */
    @Test
    public void testRead2Sub2() {
        ...
        String cmdstring = "sub 1.0 2.0";
        TestUtil.runCommand(cmdstring, new SubSacCommand());
        ...
        String sacTruth = "sub1truth.sac";
        SacTraceData truth = TestUtil.getTruth(sacTruth, TEST_FILE_DIRECTORY);
        TestUtil.compareTwoSacfileArraysExact(result, truth, "testRead2Sub2File1", tolerance);

        result = lstd.get(1);
        sacTruth = "sub2truth.sac";
        truth = TestUtil.getTruth(sacTruth, TEST_FILE_DIRECTORY);
        TestUtil.compareTwoSacfileArraysExact(result, truth, "testRead2Sub2File2", tolerance);
    }
}
