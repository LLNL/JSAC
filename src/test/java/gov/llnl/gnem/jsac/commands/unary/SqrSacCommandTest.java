...
public class SqrSacCommandTest {
    ...
    @Test
    public void testSqr() {
        testCommand("sqr", "testSqr");
    }

    @Test
    public void testSquare() {
        testCommand("square", "testSquare");
    }
    ...
    private void testCommand(String cmd, String testName) {
        ...
        SacTraceData truth = TestUtil.getTruth("sqrTruth.sac", TEST_FILE_DIRECTORY);

        TestUtil.runCommand(cmd, new SqrSacCommand());
