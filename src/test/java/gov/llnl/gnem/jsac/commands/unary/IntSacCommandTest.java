...
public class IntSacCommandTest {
    ...
    @Test
    public void testInt() {
        testCommand("int", "testInt");
    }

    @Test
    public void testIntegrate() {
        testCommand("integrate", "testIntegrate");
    }

    private void testCommand(String cmd, String testName) {
        ...
        SacTraceData truth = TestUtil.getTruth("intRectTruth.sac", TEST_FILE_DIRECTORY);

        TestUtil.runCommand(cmd, new IntSacCommand());
