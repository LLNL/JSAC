...
public class MulOmegaSacCommandTest {
    ...
    public void testMulomega() {
        ...
        TestUtil.runCommand("mulomega", new MulOmegaSacCommand());

        List<SacTraceData> lstd = SacDataModel.getInstance().getData();
        SacTraceData test = lstd.get(0);

        SacTraceData truth = TestUtil.getTruth("mulomegaTruth.sac", TEST_FILE_DIRECTORY);
