...
public class AddSacCommandTest {
    ...
    /**
     * Test reading in multiple files and adding different scalars to each
     */
    @Test
    public void testRead2Add2() {
        ...
        String cmdstring = "add 2.0 5.0";
        TestUtil.runCommand(cmdstring, new AddSacCommand());
        ...
        String sacTruth = "add2truth.sac";
        SacTraceData truth = TestUtil.getTruth(sacTruth, TEST_FILE_DIRECTORY);
        TestUtil.compareTwoSacfileArraysExact(result, truth, "testRead2Add2File1", tolerance);

        result = lstd.get(1);
        sacTruth = "add5truth.sac";
        truth = TestUtil.getTruth(sacTruth, TEST_FILE_DIRECTORY);
        TestUtil.compareTwoSacfileArraysExact(result, truth, "testRead2Add2File2", tolerance);
    }
}
