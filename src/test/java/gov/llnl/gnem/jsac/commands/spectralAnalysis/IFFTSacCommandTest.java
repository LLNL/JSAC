...
public class IFFTSacCommandTest {
    ...
    public void testIfft() {
        ...
        TestUtil.runCommand("ifft", new IFFTSacCommand());

        SacTraceData truth = TestUtil.getTruth("ifftTruth.sac", TEST_FILE_DIRECTORY);
        TestUtil.compareTwoSacfileArraysExact(test, truth, "testIfft", tolerance);
    }
}
