...
public class ExpSacCommandTest {
    ...
    public void testExp() {
        ...
        TestUtil.runCommand("exp", new ExpSacCommand());

        SacTraceData truth = TestUtil.getTruth("expTruth.sac", TEST_FILE_DIRECTORY);
        TestUtil.compareTwoSacfileArraysExact(result1, truth, "testExp", tolerance);
    }
}
