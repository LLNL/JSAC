...
public class RmeanSacCommandTest {
    ...
    public void defaultRmean() {
        ...
        TestUtil.runCommand("rmean", new RmeanSacCommand());

        SacTraceData truth = TestUtil.getTruth("rmeanTruth.sac", TEST_FILE_DIRECTORY);
        TestUtil.compareTwoSacfileArraysExact(truth, test, "defaultRmean", tolerance);
    }
}
