...
public class SqrtSacCommandTest {
    ...
    public void testSqrt() {
        ...
        SacTraceData truth = TestUtil.getTruth("sqrtTruth.sac", TEST_FILE_DIRECTORY);

        TestUtil.runCommand("sqrt", new SqrtSacCommand());

        TestUtil.compareTwoSacfileArraysExact(result, truth, "testSqrt", tolerance);
    }
}
