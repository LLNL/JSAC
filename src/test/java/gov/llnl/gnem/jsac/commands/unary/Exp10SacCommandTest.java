...
public class Exp10SacCommandTest {
    ...
    public void testExp10() {
        ...
        TestUtil.runCommand("exp10", new Exp10SacCommand());

        SacTraceData truth = TestUtil.getTruth("exp10Truth.sac", TEST_FILE_DIRECTORY);
        TestUtil.compareTwoSacfileArraysExact(result1, truth, "testExp10", tolerance);
    }
}
